...
import numpy as np
from ScatteringAna import S_ana
...
PF_Threshold = -24 # threshold for QoI in T_w (upper bound in dB)
...
np.random.seed(23)
YEO = YieldEstOpt_GPR(S_ana, FreqRangePara, PF_Threshold, N_mc, distr_uq, YE_method, Sorting_Strategy, Batch_Size, Safety_Factor, number_uq_para)
